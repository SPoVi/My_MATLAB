...
figure;
plot(domD,epn(indD));title('espectro de potencia normalizado'); 
axis([0.01 0.5 0 1.2]);
...
title("Potencia en bajas frecuencias - pLF");
xlabel('frecuencia F en Hz');ylabel('epn(F)');
...
title("Potencia en frecuencias medias - pMF");
xlabel('frecuencia F en Hz');ylabel('epn(F)');
...
title("Potencia en altas frecuencias - pHF");
xlabel('frecuencia F en Hz');ylabel('epn(F)');
