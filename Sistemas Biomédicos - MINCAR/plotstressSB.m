function plotstressSB(file, frameT, dispT, umbral_estres, pr_flag)
...
%   umbral_estres:  umbral q se considera estres =1
...
subplot(hRR)
plot(tframe, (max(RRfilt)+min(RRfilt))/2*alarma_estres, 'r^', 'LineWidth', 1.5)
subplot(hGSR)
