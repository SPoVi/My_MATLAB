function [OK,aX,aq]=UserDAP(Parametros,aqa,X,vX,q,vq)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%       Resuelve el problema de aceleración directo del robot 3RRR
%
%-Input
...
%   -aqa=[aqa1 aqa2 aqa3]', vector3x1 con la acc. de
%   las variables articulares actuadas
...
%Cálculo de Jq e inversa de Jqa
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Cálculo de dJq e inversa de dJqa
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Problema de aceleración inverso y de las var. pasivas
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

aX=Jp*aqa+dJp*vqa;

aqp=(Jqp*Jp)*aqa+(Jqp*dJp+dJqp*Jp)*vqa;
