...
acadoWorkspace.rk_diffsNew2[(i * 12) + (run1)] += + acadoWorkspace.rk_diffK[i]*(real_t)5.0000000000000003e-02;
}
}
...
for (i = 0; i < 10; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 12) + (run1 + 10)] = + acadoWorkspace.rk_diffK[i]*(real_t)5.0000000000000003e-02;
}
}
