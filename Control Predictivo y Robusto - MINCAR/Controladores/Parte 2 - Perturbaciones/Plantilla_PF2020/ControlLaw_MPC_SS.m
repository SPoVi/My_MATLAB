...
%de data.currentiter).
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% = Pert no medible ni estimada - Estimacion del Ruido =
n = data.currentiter.X - (parameters.A * data.previousiter.X +...
    parameters.B * data.previousiter.U);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Respuesta libre F*x(t)+Gp*u(t-1)
f = parameters.F*data.currentiter.X +...
    parameters.Gp*data.previousiter.U + parameters.Fr*n;
